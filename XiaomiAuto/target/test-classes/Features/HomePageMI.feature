...
When Admin clicks on "Smart Home " and on a "Maison connectée"
...
When Admin adds product "Xiaomi Humidifier 2 Lite" to the cart 
Then Admin clicks on the cart and verifies that the product "Xiaomi Humidifier 2 Lite" has been added 